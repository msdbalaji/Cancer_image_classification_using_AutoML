...
DATASET_DIR = "D:\\cancer-ai-web-backup\\5_classes"
IMG_HEIGHT = 128
IMG_WIDTH = 128
BATCH_SIZE = 32
...
tuner = Hyperband(
    ...
    project_name='lung_cancer_5class_nas'
)
...
best_model.save("5lung_cancer_nas_model.h5")
...
plt.tight_layout()
plt.savefig("5nas_model_training_plot.png")
